...
const NewsPanel = () => {
  ...
  return (
    <div className="w-80 bg-[#F7F7F8] border-l border-[#D1D5DB] flex flex-col flex-shrink-0" style={{ height: 'calc(100vh - 64px)' }}>
      ...
      <div className="flex-1 overflow-y-auto p-3 space-y-3">
        {newsItems.map((item, index) => (
          <div 
            key={index} 
            className="bg-white rounded-lg p-3 border border-[#D1D5DB] hover:shadow-md transition-shadow cursor-pointer"
          >
            <div className="flex items-start justify-between mb-2">
              ...
              <ExternalLink className="w-3 h-3 text-[#2D2D2F] opacity-50" />
            </div>
